...
a multibyte character, the filter commands, the list file of `-f`, the hook
which sets `NEXTDIR` and `PREVDIR`, and the messages of the exhausted list
(exit status 1) and the error (3).
