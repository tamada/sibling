complete -c sibling -n "__fish_use_subcommand" -s t -l type -d 'specifies the traversing type of siblings.' -r -f -a "next previous random first last"
...
complete -c sibling -n "__fish_use_subcommand" -s q -l quiet -d 'Prints version information'
